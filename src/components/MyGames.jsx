...
function MyGames() {
    ...
    return (
        <div>
            ...
            <h4 class="d-flex justify-content-center">{myGames.name}</h4>
                        ...
                        <nav>
                            <ul class="pagination justify-content-center">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <li class="page-item">
                                        <button onClick={() => setPage(setNextPage(page, totalPages))} disabled={page == totalPages} type="button" class="btn" style={{ borderColor: "#dee2e6", borderRadius: "0px 10px 10px 0px", borderLeft: "0px", backgroundColor: page == totalPages ? "#e9ecef" : "#ffffff", color: page == totalPages ? "#495057" : "#0d6efd" }}>Next</button>
                                    </li>
                                </div>
                            </ul>
                        </nav>
